    ...
    <div class="container-xxl py-5">
        <div class="container">
            <div class="row g-5 align-items-center">
                ...
                <h1 class="mb-4">Découvrez La Maison des Enfants et Nos Activités Culturelles</h1>
                <p>Bienvenue à La Maison des Enfants, un lieu chaleureux et accueillant situé au cœur de Saint-Gilles, Bruxelles. Nous offrons un environnement stimulant pour les enfants de 3 à 12 ans, où ils peuvent s'épanouir à travers diverses activités extrascolaires.</p>
                <p class="mb-4">Nos programmes sont conçus pour nourrir la curiosité et la créativité des enfants, que ce soit pendant les semaines de vacances ou tout au long de l'année. Chaque samedi après-midi, nous organisons des activités passionnantes et éducatives, permettant aux enfants de découvrir de nouvelles passions et de développer leurs compétences.</p>
                    <div class="row g-4 align-items-center">
                        <div class="col-sm-6">
                            <a class="btn btn-primary rounded-pill py-3 px-5" href="">Inscrivez-vous</a>
                        </div>
